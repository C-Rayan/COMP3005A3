...
Setup Instructions:
1. To run the application, an installation of JDBC is required (Keep track of the path/location where JDBC was downloaded)
...
P. S. Any version should be fine, as long as it's compatible with Java 8. (Others could still work)
